...
export const bettingSites: BettingSite[] = [
  ...
  },
  {
    ...
    badges: [],
    terms:
      "18+. Oferta exclusiva para novos registos. Aposta grátis de 2€ sem depósito necessário. Válida em mercados selecionados. Ganhos máximos de 50€. Válido por 7 dias após ativação. Termos e condições aplicam-se. Jogue com moderação.",
  },
]
